// --- Sample Catalog ---
const products = [
  {id:1,name:"Mango Achar (Kairi) — 500g",img:"g1.png",rating:4.8,reviews:127,oldPrice:399,price:299,sale:true},
  {id:2,name:"Lemon Achar — 450g",img:"g2.jpg",rating:4.7,reviews:88,oldPrice:349,price:289,sale:true},
  {id:3,name:"Mixed Veg Achar — 500g",img:"g3.jpg",rating:4.6,reviews:64,oldPrice:379,price:329,sale:false},
  {id:4,name:"Chilli Achar — 400g",img:"g4.jpg",rating:4.5,reviews:41,oldPrice:329,price:279,sale:true},
  {id:5,name:"Garlic Achar — 450g",img:"g5.jpg",rating:4.7,reviews:53,oldPrice:359,price:309,sale:false},
  {id:6,name:"Methi Achar — 400g",img:"g6.jpg",rating:4.4,reviews:29,oldPrice:329,price:279,sale:true}
];
...
checkoutBtn.addEventListener("click",()=>{
  ...
  const total = cart.reduce((s,i)=>s+i.price*i.qty,0);
  const productList = cart.map(item=>`• ${item.name} × ${item.qty} = ₹${item.price*item.qty}`).join('\n');

  const message = `🛒 *New Order from Tastika*\n\n${productList}\n\n💰 *Total:* ₹${total}\n\n📞 Please confirm order.`;
